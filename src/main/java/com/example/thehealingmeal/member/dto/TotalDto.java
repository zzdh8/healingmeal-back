...
public class TotalDto {
    ...
    public static TotalDto fromUser(User user) {
        return TotalDto.builder()
                ...
                .stewsAndHotpots(user.getFilterFood().getStewsAndHotpots())
                .stewedFood(user.getFilterFood().getStewedFood())
                .stirFriedFood(user.getFilterFood().getStirFriedFood())
                .grilledFood(user.getFilterFood().getGrilledFood())
                .vegetableFood(user.getFilterFood().getVegetableFood())
                .steamedFood(user.getFilterFood().getSteamedFood())
                .pancakeFood(user.getFilterFood().getPancakeFood())
                .breadAndConfectionery(user.getFilterFood().getBreadAndConfectionery())
                .beveragesAndTeas(user.getFilterFood().getBeveragesAndTeas())
                .dairyProducts(user.getFilterFood().getDairyProducts())
                .build();
    }
}
